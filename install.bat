REM Installs Notion's IntelliJ configs into your user configs.
@echo off
echo Installing Notion IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Notion'.
exit /b
